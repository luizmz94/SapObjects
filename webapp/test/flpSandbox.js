		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP Objects",
									"targetURL": "#lzzlzpsapobject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lzzlzpsapobject-display": {
								"semanticObject": "lzzlzpsapobject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lz.zlzpsapobject",
									"url": sap.ui.require.toUrl("lz/zlzpsapobject")
								}
							}
						}
					}
